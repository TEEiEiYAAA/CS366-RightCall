//index.mjs  in rightcall-main-handler

import { DynamoDBClient } from "@aws-sdk/client-dynamodb";
import { DynamoDBDocumentClient, PutCommand } from "@aws-sdk/lib-dynamodb";
import { SNSClient, PublishCommand, SubscribeCommand } from "@aws-sdk/client-sns"; // [แก้ไข] เพิ่ม SubscribeCommand
...
export const handler = async (event) => {
    try {
        ...
        if (location && location.lat && location.lng) {
            // [แก้ไข] ปรับ parameter ให้ตรงกับ API ของน้ำปั่น (lat, long)
        ...
        // =========================================================
        if (process.env.SNS_TOPIC_ARN && email) {
            
            // --- [เพิ่มใหม่] 3.1 สั่งให้ SNS นำอีเมลไปลงทะเบียนเข้ากลุ่ม ---
            try {
            ...
            const apiGatewayUrl = process.env.API_GATEWAY_URL || "https://vk8ohzpki6.execute-api.us-east-1.amazonaws.com";
            ...
            console.warn("[RightCall] SNS_TOPIC_ARN is not set or email is missing. Skipped SNS operations.");
        }
